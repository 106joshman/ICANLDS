...
const Blog = () => {
  return (
    // <div className='h-[50vh] flex justify-center items-center bg-white text-4xl' id='blog'>
    //   <h3>This will contain the District Newsletters</h3>
    // </div>
    // <!-- Container for demo purpose -->
    <div id='blog' class="container my-24 px-6 mx-auto">

      {/* <!-- Section: Design Block --> */}
      <section class="mb-32 text-gray-800 text-center">

        <h2 class="text-3xl font-bold mb-12 pb-4 text-center">District Publication</h2>
